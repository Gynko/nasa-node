...
The server queries data from the spaceX launches API, https://github.com/r-spacex/SpaceX-API, and also populates a list planets from a CSV file from NASA data.
